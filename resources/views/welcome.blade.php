                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                                <a href="{{ route('shopdetail.index', $prod->id) }}">
                ...
                <div class="col-md-6 col-lg-4">
                    <a href="#">
                        <div class="service-item bg-secondary rounded border border-secondary">
                            <img src="{{ asset('UI/img/featur-1.jpg') }}" class="img-fluid rounded-top w-100"
                                alt="">
                ...
                <div class="col-md-6 col-lg-4">
                    <a href="#">
                        <div class="service-item bg-dark rounded border border-dark">
                            <img src="{{ asset('UI/img/featur-2.jpg') }}" class="img-fluid rounded-top w-100"
                                alt="">
                            <div class="px-4 rounded-bottom">
                ...
                <div class="col-md-6 col-lg-4">
                    <a href="#">
                        <div class="service-item bg-primary rounded border border-primary">
                            <img src="{{ asset('UI/img/featur-3.jpg') }}" class="img-fluid rounded-top w-100"
                                alt="">
                            <div class="px-4 rounded-bottom">
    ...
    <div class="container-fluid vesitable py-5">
        <div class="container py-5">
            ...
            <div class="owl-carousel vegetable-carousel justify-content-center">
                @foreach ($vegetableProducts as $p)
                    <div class="border border-primary rounded position-relative vesitable-item">
                        <div class="vesitable-img">
                            <a href="{{ route('shopdetail.index', $p->id) }}">
                            <img src="{{ asset('uploads/' . $p->image) }}" class="img-fluid w-100 rounded-top"
                                alt="{{ $p->title }}" width=500px height=400px>
                            </a>
                        </div>
            ...
            <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="position-relative">
                        <img src="{{ asset('UI/img/baner-1.png') }}" class="img-fluid w-100 rounded" alt="">
                    ...
                    @if ($p1->status == 1)
                        <div class="col-md-6 col-lg-6 col-xl-3">
                            <div class="text-center">
                                <a href="{{ route('shopdetail.index', $p1->id) }}">
